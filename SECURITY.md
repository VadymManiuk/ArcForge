...
- The active Arc Testnet V2 Factory contains the hardened curve implementation; the previous Factory is retained as an indexed legacy source for existing tokens.
